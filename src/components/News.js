...
export class News extends Component {
  ...
  async componentDidMount() {
    console.log("kash");
     let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=business&apiKey=dec6391d925b4696b003190c69a3ef7c&page=${this.state.page }&pageSize=${this.props.pageSize}`;
  ...
  handleprevious = async () => {
    ...
    if (this.state.page > 1) {
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=business&apiKey=dec6391d925b4696b003190c69a3ef7c&page=${this.state.page - 1}&pageSize=${this.props.pageSize}`;
       this.setState({loading:true})
      let data = await fetch(url);
      let parsedata = await data.json();
      this.setState({
